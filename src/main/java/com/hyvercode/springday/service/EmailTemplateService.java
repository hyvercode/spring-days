...
import com.hyvercode.springday.component.EmailService;
...
public class EmailTemplateService {
  ...
  public EmailTemplateService(EmailTemplateRepository emailTemplateRepository, EmailService emailService) {
